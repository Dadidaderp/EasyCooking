...
CREATE TABLE IF NOT EXISTS `commentaire` (
  ...
  PRIMARY KEY (`fk_utilisateur_id`,`fk_recette_id`),
  KEY `fk_utilisateur_has_recette_recette1_idx` (`fk_recette_id`),
  KEY `fk_utilisateur_has_recette_utilisateur_idx` (`fk_utilisateur_id`)
...
INSERT INTO `commentaire` (`fk_utilisateur_id`, `fk_recette_id`, `commentaire`, `date`) VALUES
(1, 3, 'j''ai en mangé une pleine brouette', '2017-01-05 00:00:00'),
(2, 1, 'enfin une recette traditionel des escargots du pere ducras', '2017-02-02 00:00:00');
